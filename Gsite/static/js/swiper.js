...
!(function (e, t) {
        ...
        on: function () {
            ...
            function o(e) {
                ...
                if (t) {
                    ...
                    if ((a.indexOf(e) < 0 && a.unshift(e), I(t).is(r)))
                        n.apply(t, a);
                    else
                        for (
                            var i = I(t).parents(), s = 0;
                            s < i.length;
                            s += 1
                        )
        ...
        ae =
            ((s = f.createElement("div")),
            {
                ...
                pointerEvents: !!(
                    ...
                    ee.PointerEvent ||
                    ("maxTouchPoints" in ee.navigator &&
                        0 < ee.navigator.maxTouchPoints)
                ),
                ...
                observer:
                    "MutationObserver" in ee || "WebkitMutationObserver" in ee,
    ...
    (e.prototype.on = function (e, t, a) {
        ...
        (e.installModule = function (t) {
            ...
            var s =
                t.name ||
                Object.keys(i.prototype.modules).length + "_" + te.now();
            return (
                        ...
                        if ("auto" === t.slidesPerView) {
                            ...
                            if (
                                ...
                                var H = parseFloat(D.getPropertyValue("width")),
                                    G = parseFloat(
                                        D.getPropertyValue("padding-left"),
                                    ),
                                    N = parseFloat(
                                        D.getPropertyValue("padding-right"),
                                    ),
                                    B = parseFloat(
                                        D.getPropertyValue("margin-left"),
                                    ),
                                    X = parseFloat(
                                        D.getPropertyValue("margin-right"),
                                    ),
                                ...
                                var Y = parseFloat(
                                        D.getPropertyValue("height"),
                                    ),
                                    F = parseFloat(
                                        D.getPropertyValue("padding-top"),
                                    ),
                                    R = parseFloat(
                                        D.getPropertyValue("padding-bottom"),
                                    ),
                                    q = parseFloat(
                                        D.getPropertyValue("margin-top"),
                                    ),
                                    W = parseFloat(
        ...
        updateActiveIndex: function (e) {
            ...
            if (
                ...
                te.extend(a, {
                    ...
                    (a.initialized || a.runCallbacksOnInit) &&
                        a.emit("slideChange");
    ...
    var h = {
        loopCreate: function () {
            ...
            for (var p = o.length - 1; 0 <= p; p -= 1)
                t.prepend(
                    I(o[p].cloneNode(!0)).addClass(e.slideDuplicateClass),
                );
        },
        loopFix: function () {
            var e,
                                ...
                                if (
                                    ...
                                    if (
                                        ...
                                        if (
                                            ...
                                            var p = !0;
                                            I(r.target).is(a.formElements) &&
                                                (p = !1),
                                                f.activeElement &&
                                                    I(f.activeElement).is(
                                                        a.formElements,
                                                    ) &&
                                                    f.activeElement !==
                                                        r.target &&
                    ...
                    0 !== t.length &&
                        ...
                        e.clickable &&
                            t.on("click", "." + e.bulletClass, function (e) {
                                e.preventDefault();
                                var t =
                                    I(this).index() * a.params.slidesPerGroup;
            ...
            onTouchMove: function (e) {
                ...
                if (
                    ...
                    s.isMoved ||
                        ...
                        (s.startX =
                            te.getTranslate(i.$imageWrapEl[0], "x") || 0),
                        (s.startY =
                            te.getTranslate(i.$imageWrapEl[0], "y") || 0),
                    ...
                    te.extend(e, {
                        controller: {
                            ...
                            getInterpolateFunction:
                                V.getInterpolateFunction.bind(e),
