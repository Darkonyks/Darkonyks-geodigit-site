...
!(function (t, e) {
            ...
            if (
                ...
                "ontouchstart" in document.documentElement &&
                    ...
                    []
                        ...
                        .forEach((t) =>
                            P.on(t, "mouseover", null, function () {}),
                        ),
                    this._element.focus(),
        ...
        static clearMenus(t) {
            ...
            for (let s = 0, i = e.length; s < i; s++) {
                const i = w.get(e[s], "bs.dropdown"),
                    n = { relatedTarget: e[s] };
                if ((t && "click" === t.type && (n.clickEvent = t), !i))
                    continue;
                const o = i._menu;
                    ...
                    P.trigger(e[s], "hide.bs.dropdown", n).defaultPrevented ||
                        ("ontouchstart" in document.documentElement &&
                            []
                                .concat(...document.body.children)
                                .forEach((t) =>
                                    P.off(t, "mouseover", null, function () {}),
                                ),
    ...
    P.on(
        ...
        function (t) {
            ...
            (s && s !== e) ||
                (w.get(e, "bs.offcanvas") || new _t(e)).toggle(this);
        },
    ),
    ...
    const bt = new Set([
        ...
        wt = (t, e) => {
            ...
            if (e.includes(s))
                return (
                    !bt.has(s) ||
                    Boolean(vt.test(t.nodeValue) || yt.test(t.nodeValue))
                );
        ...
        _setListeners() {
            this.config.trigger.split(" ").forEach((t) => {
                if ("click" === t)
                    ...
                    P.on(this._element, e, this.config.selector, (t) =>
                        this._enter(t),
                    ),
